...
class FileUploadBehavior extends CActiveRecordBehavior
{
    ...
    public function attach($owner)
    {
        ...
        $this->fileNameOld = $this->getOwner()->{$this->attributeName};
    ...
    {
        $fileName = $this->getOwner()->{$this->attributeName};
        
        if($fileName instanceof CUploadedFile){
            $fileName = $this->fileNameOld;
        }
