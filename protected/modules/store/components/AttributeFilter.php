...
class AttributeFilter extends CApplicationComponent
{
    ...
    const MAIN_SEARCH_PARAM_NEWS = 'is_new';
    /**
     *
     */
    const MAIN_SEARCH_PARAM_SPEC= 'is_special';
    /**
     *
     */
     ...
     *
     */
    const MAIN_SEARCH_PARAM_STOCK = 'stock';
    ...
    public function getMainSearchParams()
    {
        return [
            ...
            self::MAIN_SEARCH_PARAM_NEWS => 'is_new',
            self::MAIN_SEARCH_PARAM_PRICE => 'price_result',
            self::MAIN_SEARCH_PARAM_WIDTH => 'width',
            self::MAIN_SEARCH_PARAM_HEIGHT => 'height',
            self::MAIN_SEARCH_PARAM_LENGTH => 'length',
            self::MAIN_SEARCH_PARAM_STOCK => 'in_stock',
            self::MAIN_SEARCH_PARAM_STOCK => 'is_special',
        ];
    }
