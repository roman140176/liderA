...
class ServicesModule  extends yupe\components\WebModule
{
    const VERSION = '0.9.8';
    ...
    {
        return Yii::t('YupeModule.yupe', 'Услуги');
    }
    ...
    {
        return [
            ['label' => Yii::t('ServicesModule.services', 'Услуги')],
            [
                'icon' => 'fa fa-tasks',
                'label' => Yii::t('ServicesModule.services', 'Услуги'),
    ...
    {
        return Yii::t('ServicesModule.services', self::VERSION);
    }
    ...
    {
        return Yii::t('ServicesModule.services', 'https://yupe.ru');
    }
    ...
    {
        return Yii::t('ServicesModule.services', 'Услуги');
    }
    ...
    {
        return Yii::t('ServicesModule.services', 'Описание модуля "services"');
    }
            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'description' => Yii::t('ServicesModule.services', 'Index')
                    ],
                ]
            ]
        ];
