...
class News extends yupe\models\YModel
{
    ...
    public function getUrl(){
     ...
     public function newsDateRusFormat(){
            return Yii::app()->dateFormatter->format('dd.LL.yyyy', strtotime($this->date));
        }
        public function getCategoryUrl(){
            return Yii::app()->createUrl('/news/newsCategory/view', ['slug'=>$this->category->slug]);
        }
}
