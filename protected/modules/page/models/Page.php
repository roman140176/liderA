...
class Page extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['parent_id, category_id, is_special', 'numerical', 'integerOnly' => true, 'allowEmpty' => true],
            ['parent_id, category_id', 'default', 'setOnEmpty' => true, 'value' => null],
            ['lang', 'length', 'max' => 2],
            ['lang', 'default', 'value' => Yii::app()->sourceLanguage],
            ['slug', 'length', 'max' => 150],
            ['title, name_h1, title_short, meta_title, meta_keywords, meta_description, layout, view', 'length', 'max' => 250],
            ...
            ['title, name_h1, title_short, slug, body, body_short, meta_title, meta_description, meta_keywords', 'filter', 'filter' => 'trim'],
            ['title, name_h1, title_short, slug, meta_title, meta_description, meta_keywords', 'filter', 'filter' => [new YPurifier(), 'purify']],
            ...
            ['image, icon, body_short, data', 'safe'],
            [
                'lang, id, parent_id, create_time, update_time, title, name_h1, title_short, slug, body, meta_title, meta_keywords, meta_description, status, order, lang, body_short',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name_h1' => Yii::t('PageModule.page', 'Заголовок на странице'),
            'is_special' => 'Учавствует в доп.меню',
        ];
    }
    ...
    {
        return Yii::app()->createUrl('/page/page/view', ['slug'=>$this->slug]);
    }

    public function getTitle()
    {
        return $this->name_h1 ? : $this->title;
    }
}
