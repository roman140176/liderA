...
class Order extends yupe\models\YModel
{
    ...
    public function rules()
    {
        return [
            ...
            ['name, phone', 'required', 'on' => self::SCENARIO_USER],
            ['email', 'email'],
            [
            ...
            ['url', 'unique'],
            [
                'user_id, paid, payment_time, delivery_time, payment_details, total_price, discount, coupon_discount, separate_delivery, status_id, date, ip, url, modified',
                'unsafe',
                'on' => self::SCENARIO_USER,
            ],
            [
                'id, delivery_id, delivery_price, payment_method_id, paid, payment_time, delivery_time, payment_details, total_price, discount, coupon_discount, separate_delivery, status_id, date, user_id, name, phone, email, comment, ip, url, note, modified, manager_id',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'name' => Yii::t('OrderModule.order', 'Ф.И.О.'),
